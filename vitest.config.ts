...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@foundry/diagnostics": fromRoot("./packages/diagnostics/src/index.ts"),
      "@foundry/evaluation": fromRoot("./packages/evaluation/src/index.ts"),
      ...
      "@foundry/security": fromRoot("./packages/security/src/index.ts"),
